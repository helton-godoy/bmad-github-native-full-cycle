...
router.get('/tasks/:id/cot', (req, res) => {
    ...
    sendSSE(res, { type: 'connected', taskId: id, message: 'CoT stream connected' });
...
router.get('/tasks/:id/logs', (req, res) => {
    ...
    sendSSE(res, { type: 'connected', taskId: id, message: 'Log stream connected' });

    // Mock: Stream logs
    const mockLogs = [
        { level: 'info', message: 'Started implementation of auth service', source: 'developer-agent' },
        { level: 'info', message: 'Created file: src/services/auth.service.ts', source: 'developer-agent' },
        { level: 'warn', message: 'Deprecation warning: jwt.verify() options parameter', source: 'eslint' },
        { level: 'info', message: 'Running test suite: auth.test.ts', source: 'jest' },
        { level: 'error', message: 'Test failed: should handle expired tokens', source: 'jest' },

...
if (fs.existsSync(pkgPath)) {
    try {
        ...
        console.log("🔧 package.json atualizado com scripts de segurança e documentação.");
    } catch (err) {
        console.error(`❌ Erro ao atualizar package.json: ${err.message}`);
    }
} else {
    console.log("⚠️  Aviso: package.json não encontrado. Execute 'npm init' e rode o setup novamente.");
}

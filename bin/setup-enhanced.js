...
console.log(
  '\x1b[33m📋 Setting up advanced features with enhanced personas and documentation...\x1b[0m'
);
...
const enhancedScripts = [
  {
    src: 'scripts/bmad/bmad-workflow-enhanced.js',
    dest: 'scripts/bmad/bmad-workflow-enhanced.js',
  },
  {
    src: 'scripts/bmad/bmad-orchestrator.js',
    dest: 'scripts/bmad/bmad-orchestrator.js',
  },
  {
    src: 'scripts/bmad/bmad-workflow.js',
    dest: 'scripts/bmad/bmad-workflow.js',
  },
  {
    src: 'scripts/bmad/agent-doc-enhanced.js',
    dest: 'scripts/bmad/agent-doc-enhanced.js',
  },
  { src: 'scripts/bmad/agent-doc.js', dest: 'scripts/bmad/agent-doc.js' },
  {
    src: 'scripts/bmad/bmad-gatekeeper.js',
    dest: 'scripts/bmad/bmad-gatekeeper.js',
  },
];
...
if (fs.existsSync(pkgPath)) {
  try {
    ...
    pkg.scripts['bmad:workflow'] =
      'node scripts/bmad/bmad-workflow-enhanced.js';
    pkg.scripts['bmad:workflow:original'] =
      'node scripts/bmad/bmad-workflow.js';
    pkg.scripts['bmad:workflow:single'] =
      'node scripts/bmad/bmad-workflow-enhanced.js';
    ...
    pkg.scripts['setup'] =
      'npm install && chmod +x scripts/bmad/*.js && chmod +x scripts/*.js';
    pkg.scripts['status'] =
      'node -e "console.log(\'Enhanced BMAD Framework v2.0.0 - Ready for autonomous development!\')"';
    pkg.scripts['validate'] = 'npm run lint && npm run test';
    pkg.scripts['clean'] =
      'rm -rf .github/logs/ .github/reports/ .github/metrics/ node_modules/.cache/';
    ...
    console.log(
      '✅ Enhanced package.json configured with advanced BMAD scripts and metadata.'
    );
  } catch (err) {
  ...
  console.log(
    "⚠️  Warning: package.json not found. Run 'npm init' and setup again."
  );
}
...
const validationChecks = [
  {
    path: 'scripts/bmad/bmad-workflow-enhanced.js',
    name: 'Enhanced Workflow Script',
  },
  {
    path: 'scripts/bmad/agent-doc-enhanced.js',
    name: 'Enhanced Documentation Script',
  },
  { path: 'personas/base-persona-enhanced.js', name: 'Enhanced Base Persona' },
  {
    path: 'personas/developer-enhanced.js',
    name: 'Enhanced Developer Persona',
  },

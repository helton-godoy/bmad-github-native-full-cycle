...
## 📄 `tests/mocks/octokit.js`
### 🧠 Context
- Mock for @octokit/rest
### 🛡️ Invariants (DO NOT BREAK)
- 🔴 **Mock all GitHub API calls for testing**
### 🔗 Connections
- ➡️ Provides consistent mock responses for GitHub operations

---

## 📄 `tests/personas/personas.test.js`
### 🧠 Context
- Test suite for BMAD personas
### 🛡️ Invariants (DO NOT BREAK)
- 🔴 **All personas must be loadable and functional**
### 🔗 Connections
- ➡️ Tests validate persona integration and workflow
...
### 🔗 Connections
- ➡️ Setup consistent test environment across all tests
...
### 🔗 Connections
- ➡️ Tests validate workflow execution and GitHub integration
